...
if(isset($_POST['email'])) {
    ...
    $email_to = "comercial.jackspethouse@gmail.com";
...
echo "<script>alert("Obrigado! Em breve entraremos em contato");window.location.assign('http://www.jackspet.com.br/');</script>";
